...
/******************************* Program Notes ********************************
        ...
        LCD RW line (pin 5) is not connected to the uC and it must be
		...
		This program writes AVR-DEV_BOARD and ---EXCEL TECH--- on LCD screen
*****************************************************************************/

#define F_CPU 8000000UL							//define CPU clock frequency as 8MHz.
...
//LCD instructions
#define lcd_Clear           0b00000001          //clear LCD screen.
...
// Program ID
uint8_t program_title[]   = "AVR-Dev_Board";
uint8_t program_author[]  = "---Excel Tech---";
...
int main(void)
{
// configure pins for the data lines.
    lcd_D7_ddr |= (1<<lcd_D7_bit);							//4 data lines - output.
    lcd_D6_ddr |= (1<<lcd_D6_bit);
    lcd_D5_ddr |= (1<<lcd_D5_bit);
    lcd_D4_ddr |= (1<<lcd_D4_bit);

//configure pins for the control lines.
    lcd_E_ddr  |= (1<<lcd_E_bit);							//E line - output.
    lcd_RS_ddr |= (1<<lcd_RS_bit);
								//RS line - output.
	lcd_init_4d();											//initialize the LCD display for a 4-bit interface.
	lcd_write_string_4d(program_title);						//display the first line of information.
	lcd_write_instruction_4d(lcd_SetCursor | lcd_LineTwo);	//set cursor to start of second line.
    _delay_us(80);											//80uS delay. 
	lcd_write_string_4d(program_author);					//display the second line of information.
	return 0;
}
